      ...
      <div className="p-5">
        ...
        <nav className={`${isMenuOpen ? 'block' : 'hidden'} lg:block`}>
          <div className="space-y-1">
            ...
            <Link href="/">
              <a className={`flex items-center py-2 px-3 rounded-lg mb-1 ${location === '/' ? 'bg-primary bg-opacity-20 border-l-4 border-highlight' : 'hover:bg-white hover:bg-opacity-10 transition-all'}`}>
            ...
            <a className="flex items-center py-2 px-3 rounded-lg mb-1 hover:bg-white hover:bg-opacity-10 transition-all cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-8 space-y-1">
            ...
            {(playlistsData || []).map((playlist: any) => (
              <a key={playlist.id} className="flex items-center py-2 px-3 rounded-lg mb-1 hover:bg-white hover:bg-opacity-10 transition-all cursor-pointer">
                {playlist.imageUrl ? (
